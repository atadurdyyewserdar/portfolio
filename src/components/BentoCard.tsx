...
const Portfolio: React.FC = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen bg-white dark:bg-gray-900 p-4 sm:p-6 lg:p-8 overflow-x-hidden transition-colors duration-300">
      {/* Theme toggle button - fixed in top right */}
      <div className="fixed top-4 right-4 z-50">
        <ThemeToggle />
      </div>
      
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-6 sm:gap-8 lg:gap-10 xl:gap-12 h-full">
        <div className="col-span-12 lg:col-span-3 lg:mt-0 static lg:sticky lg:top-8 lg:self-start lg:overflow-visible">
        ...
        <div
          className="col-span-12 lg:col-span-9 space-y-5 lg:pl-16 xl:pl-20 2xl:pl-28 lg:overflow-y-auto lg:h-[calc(100vh-4rem)] hide-scrollbar pr-2 sm:pr-4"
        >
          <div
